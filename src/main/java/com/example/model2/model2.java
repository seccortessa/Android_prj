...
public class model2 extends AppCompatActivity implements OnFragmentInteractionListener{
    ...
    private model2 thisClass;
    private final Thread BgThread = new Thread() {
    @Override
    public void run() {
            String argv[] = new String[] {"MainActivity","model2"};
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Log.e("model2.updateTextViewById", ex.getLocalizedMessage());
                }
            }
        });
    }
...
timerZoomButton.start();
    ...
    private native int naMain(String[] argv, model2 pThis);
